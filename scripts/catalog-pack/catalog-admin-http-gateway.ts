 ...
 *
 * The plan's twelve operation kinds are the twelve actions `POST /api/admin/catalog` accepts, so an
 * operation is one request. Going through the endpoint rather than talking to the database keeps the
